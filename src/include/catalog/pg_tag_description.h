...
CATALOG(pg_tag_description,6485,TagDescriptionRelationId) BKI_SHARED_RELATION BKI_ROWTYPE_OID(6486,TagDescriptionRelation_Rowtype_Id) BKI_SCHEMA_MACRO
{
	...
	text		tagvalue[1];		/* tag value for this object */
#endif
...
DECLARE_UNIQUE_INDEX_PKEY(pg_tag_description_c_o_o_t_index, 6487, on pg_tag_description using btree(classid oid_ops, objid oid_ops, objsubid int4_ops, tagid oid_ops));
